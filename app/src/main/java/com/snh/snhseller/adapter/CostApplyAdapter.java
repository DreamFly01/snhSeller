 ...
 * <p>version：1<p>
 */
public class CostApplyAdapter extends BaseQuickAdapter<CostApplyBean,BaseViewHolder> {
    public CostApplyAdapter(int layoutResId, @Nullable List<CostApplyBean> data) {
