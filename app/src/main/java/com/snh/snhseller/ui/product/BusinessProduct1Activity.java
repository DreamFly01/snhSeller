 ...
 * <p>version：1<p>
 */
public class BusinessProduct1Activity extends BaseActivity {
        ...
        adapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
            ...
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                ...
                if (datas.get(position).IsSetNorm) {
                    JumpUtils.dataJump(BusinessProduct1Activity.this, SkuListActivity.class, bundle, false);
                } else {
                    JumpUtils.dataJump(BusinessProduct1Activity.this, AddSkuActivity.class, bundle, false);
                }
            }
        });
    }
    ...
    private void setRecyclerView() {
        ...
        recyclerView.addItemDecoration(new RecycleViewDivider(BusinessProduct1Activity.this, LinearLayoutManager.VERTICAL, R.drawable.line));
        recyclerView.setLayoutManager(new LinearLayoutManager(BusinessProduct1Activity.this));
        recyclerView.setAdapter(adapter);
    }

    private void getData() {
        RequestClient.MyCommodityList(index, condition, type, BusinessProduct1Activity.this, new NetSubscriber<BaseResultBean<List<BusinessBean>>>(BusinessProduct1Activity.this, isShow) {
            @Override
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.btn_commit:
                jumpActivity(BusinessProduct2Activity.class);
                break;
        }
    }
