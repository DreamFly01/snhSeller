 ...
 * <p>version：1<p>
 */
public class EditProduct1Activity extends BaseActivity implements TakePhoto.TakeResultListener, InvokeListener {
    ...
    protected void initContentView(Bundle savedInstanceState) {
        setContentView(R.layout.activity_editproduct1_layout);
...
//            et06.setText(bean.MarketPrice + "");
    ...
    @OnClick({R.id.heard_back, R.id.btn_commit, R.id.et_02,R.id.iv_logo})
...
//        }
            ...
            public void onResultNext(BaseResultBean model) {
                dialogUtils.simpleDialog("新增商品成功", new DialogUtils.ConfirmClickLisener() {
                    ...
                    public void onConfirmClick(View v) {
                        SPUtils.getInstance(EditProduct1Activity.this).savaBoolean(Contans.FRESH, true).commit();
    ...
    private void showPickView(final int type) {
        ...
        OptionsPickerView pvOptions = new OptionsPickerBuilder(EditProduct1Activity.this, new OnOptionsSelectListener() {
            @Override
