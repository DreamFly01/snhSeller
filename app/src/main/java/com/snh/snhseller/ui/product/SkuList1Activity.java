...
import com.snh.snhseller.adapter.SkuList1Adapter;
 ...
 * <p>version：1<p>
 */
public class SkuList1Activity extends BaseActivity {
            ...
            public void onItemChildClick(final BaseQuickAdapter adapter, View view, final int position) {
                switch (view.getId()) {
                    ...
                    case R.id.ll_item:
                       ...
                       JumpUtils.dataJump(SkuList1Activity.this,AddSkuActivity.class,bundle,false);
                        break;
                }
            }
        });
    ...
    private void setRecyclerView() {
        adapter = new SkuListAdapter(R.layout.activity_skulist1_layout, null);
        adapter.setGoodsId(goodsId);
