...
public class BadgeUtils {
    ...
    public static void setBadgeCount(Context context, int count, int iconResId) {
        ...
        } else if (Build.MANUFACTURER.toLowerCase().equalsIgnoreCase("samsung") ||
                Build.MANUFACTURER.toLowerCase().equalsIgnoreCase("lg")) {
            setBadgeOfSumsung(context, count);
        } else if (Build.MANUFACTURER.toLowerCase().equalsIgnoreCase("htc")) {
            setBadgeOfHTC(context, count);
        } else if (Build.MANUFACTURER.toLowerCase().equalsIgnoreCase("nova")) {
            setBadgeOfNova(context, count);
        }else if (Build.MANUFACTURER.toLowerCase().equalsIgnoreCase("OPPO")) {//oppo
            //setBadgeOfOPPO(context, count);
        }else if (Build.MANUFACTURER.toLowerCase().equalsIgnoreCase("LeMobile")) {//乐视

        }
        else if (Build.MANUFACTURER.toLowerCase().equalsIgnoreCase("vivo")) {
            setBadgeOfVIVO(context, count);
        }else if (Build.MANUFACTURER.toLowerCase().equalsIgnoreCase("HUAWEI")||Build.BRAND.equalsIgnoreCase("Huawei")||Build.BRAND.equalsIgnoreCase("HONOR")) {//华为
            setHuaweiBadge(context, count);
        }else if (Build.MANUFACTURER.toLowerCase().equalsIgnoreCase("")) {//魅族

        }else if (Build.MANUFACTURER.toLowerCase().equalsIgnoreCase("")) {//金立

        }else if (Build.MANUFACTURER.toLowerCase().equalsIgnoreCase("")) {//锤子
