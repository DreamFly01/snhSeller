 ...
 * <p>version：1<p>
 */
public class MyAppointProductAdapter extends BaseQuickAdapter<CouponsProductIdBean,BaseViewHolder> {

    public MyAppointProductAdapter(int layoutResId, @Nullable List<CouponsProductIdBean> data) {
    ...
    protected void convert(BaseViewHolder helper, CouponsProductIdBean item) {
        ...
        helper.setText(R.id.coupons_tv_name,item.GoodsName);
    }
}
