...
import com.snh.moudle_coupons.adapter.MyCouponsAdapter;
...
import com.snh.moudle_coupons.ui.activity.EditCouponsActivity;
...
public class MyCouponsFragment extends BaseFragment {
    ...
    public void setUpLisener() {
        ...
        adapter.setOnItemChildClickListener(new BaseQuickAdapter.OnItemChildClickListener() {
            ...
            public void onItemChildClick(BaseQuickAdapter adapter, View view, int position) {
                if(view.getId()==R.id.coupons_tv_look){
                    if (datas.get(position).CouponWay == 2) {
                ...
                }else if(view.getId() == R.id.coupons_ll_edit){
                    Bundle bundle = new Bundle();
                    bundle.putParcelable("data",datas.get(position));
                    JumpUtils.dataJump(getActivity(),EditCouponsActivity.class,bundle,false);
                }
            }
        });
    ...
    private void setRecyclerView() {
        adapter = new MyCouponsAdapter(R.layout.coupons_item_mycoupons_layout, null);
    ...
    private void getData() {
        addSubscription(RequestClient.GetCouponsList(index, getContext(), new NetSubscriber<BaseResultBean<List<CouponsBean>>>(getContext(), isShow) {
            @Override
